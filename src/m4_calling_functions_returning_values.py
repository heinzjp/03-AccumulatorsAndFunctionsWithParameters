...
def run_test_digits_in_power():
    ...
    # Test 2:
    expected = 27
    answer = digits_in_power(15, 6)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 0
    answer = digits_in_power(0, 5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def fancy_sums_of_digits(n):
    ...
    numx = sum_of_digits(n**1000)
    numy = sum_of_digits(n**999)
    ans = digits_in_power(numx, numy)
    return ans
