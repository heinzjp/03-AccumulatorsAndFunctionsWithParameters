...
def two_circles():
    ...
    circle1 = rg.Circle(rg.Point(250,250), 98)
...
def circle_and_rectangle():
    ...
    rectangle = rg.Rectangle(rg.Point(200, 200), rg.Point(300, 300))
...
def lines():
    ...
    window = rg.RoseWindow(400, 400)
    line1 = rg.Line(rg.Point(10, 10), rg.Point(390, 390))
    line2 = rg.Line(rg.Point(10, 390), rg.Point(390, 10))
    line1.thickness = 5
