...
def draw_circles1():
    ...
    for k in range(20):
        circle = rg.Circle(rg.Point(200, 200), print_sequence1(k))
...
def draw_circles2():
    ...
    window = rg.RoseWindow(400, 400)
    for k in range(18):
        circle = rg.Circle(rg.Point(print_sequence2(k)-20, 100), 10)
...
def draw_circles3():
    ...
    for k in range(100):
        circle = rg.Circle(rg.Point(200, 150), print_sequence3(k))
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    for k in range(101):
        circle = rg.Circle(rg.Point(200 + print_cosines(k), 200 + print_sines(k)), 10)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
